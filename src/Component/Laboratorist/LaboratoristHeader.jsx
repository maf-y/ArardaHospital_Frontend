...
export default function LaboratoristHeader() {
        ...
        {isOpen && (
          ...
          >
            <div className="p-4">
              ...
              <div className="text-lg font-semibold text-[#04353D]">Laboratorist John Doe</div>
              <div className="text-sm text-gray-600">Experience: 7 years</div>
              <div className="text-sm text-gray-600">Specialization: Lab Technician</div>
